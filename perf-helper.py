...
col_names = ['Argument parsing', 'Module initialization', 'Preopen', 'Landlock enforcement', 'Running WASM binary', 'Argument parsing (cumulative)', 'Module initialization (cumulative)', 'Preopen (cumulative)', 'Landlock enforcement (cumulative)', 'Running WASM binary (cumulative)']
